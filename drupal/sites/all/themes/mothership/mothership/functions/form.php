...
//  element_set_attributes($element, array('id', 'name',  'maxlength'));
  ...
  if($variables['element']['#id'] == "edit-pass-pass1"){
     return '<small class="help-block">'. t('Enter a password').'</small><input' . drupal_attributes($element['#attributes']) . ' />' ;
  }elseif($variables['element']['#id'] == "edit-pass-pass2"){
     return '<small class="help-block">'. t('Repeat the password').'</small><input' . drupal_attributes($element['#attributes']) . ' />' ;
  }else{
    return '<input' . drupal_attributes($element['#attributes']) . ' />' ;
  }
