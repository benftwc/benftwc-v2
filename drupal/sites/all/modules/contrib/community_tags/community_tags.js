  ...
  Drupal.behaviors.communityTags = {
    attach: function(context) {
      ...
      $('input.form-tags', context).once('form-tags', function () {
        ...
        // Fetch settings.
        var entity_id = $('input[name=entity_id]', this.form).val();
        var entity_type = $('input[name=entity_type]', this.form).val();
        var entity_key = 'e_' + entity_type + '_' + entity_id;
        var o = Drupal.settings.communityTags[entity_key];
        var vid = $('input[name=vid]', this.form).val();
        var o = Drupal.settings.communityTags[entity_key]['v_' + vid];
